...
A simple, cross-platform tool to convert PowerPoint presentations (.pptx) into PDF files.
...
Execute the script: Run the command below in your terminal to successfully convert your file:
```py
python convert.py
```
